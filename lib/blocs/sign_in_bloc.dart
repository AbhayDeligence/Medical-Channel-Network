...
class SignInBloc extends ChangeNotifier {
  ...
  bool _workinmc = false;
  bool get workinmc => _workinmc;
  ...
  List? _initial;
  List? get initial => _initial;

  String? _name;
  String? get name => _name;

  String? _nearMc;
  String? get nearmc => _nearMc;
  ...
  Future signUpwithEmailPassword(userName, userEmail, userPassword, orgName,
      nearMC, initial, workinmc, headline) async {
    try {
  ...
  Future getDataFromSp() async {
    ...
    _orgname = sp.getString('organizationName');
    _headline = sp.getString('headline');
  ...
  Future updateUserProfile(
      String newName, String newImageUrl, String headline) async {
    final SharedPreferences sp = await SharedPreferences.getInstance();

    FirebaseFirestore.instance.collection('users').doc(_uid).update(
        {'name': newName, 'image url': newImageUrl, 'headline': headline});
